            ...
            <fieldset class="row mb-3">
                ...
                <div class = "col-sm-9">
                    <div class ="form-check">
                        <input type="radio" name="product_sort" value="pellet" id="pellet" class="form-check-input">
                        <label for="pellet" class="form-check-label">Pellets</label>
                    </div>
                    <div class ="form-check">
                        <input type="radio" name="product_sort" value="briquette" id="briquette" class="form-check-input">
                        <label for="briquette" class="form-check-label">Briquettes</label>
                    </div>
                    <div class ="form-check">
                        <input type="radio" name="product_sort" value="firewood" id="firewood" class="form-check-input">
